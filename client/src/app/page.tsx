          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-neutral-900 mb-6">
                About <span className="gradient-text">TalentAI</span>
              </h2>
              <p className="text-lg text-neutral-600 mb-6 leading-relaxed">
                TalentAI is a revolutionary AI-powered talent marketplace that connects exceptional 
                AI professionals with forward-thinking companies. Our platform leverages cutting-edge 
                machine learning algorithms to ensure perfect matches between candidates and opportunities.
              </p>
              <p className="text-lg text-neutral-600 mb-8 leading-relaxed">
                We believe that the future of hiring lies in intelligent automation combined with 
                human expertise. Our comprehensive assessment system evaluates candidates through 
                coding challenges, personality tests, and interactive games, ensuring only the 
                most qualified professionals reach your organization.
              </p>
              
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center p-4 bg-gradient-to-br from-primary-50 to-primary-100 rounded-xl">
                  <div className="text-3xl font-bold text-primary-600 mb-2">10K+</div>
                  <div className="text-sm text-primary-700">Active Candidates</div>
                </div>
                <div className="text-center p-4 bg-gradient-to-br from-secondary-50 to-secondary-100 rounded-xl">
                  ...
                  <div className="text-sm text-secondary-700">Partner Companies</div>
                </div>
              </div>
            </div>
