            ...
            <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto font-medium">
              Discover amazing job opportunities with our intelligent matching system. Swipe through jobs and find your perfect match.
                ...
                <button 
                  ...
                  className="border-2 border-white text-white px-8 py-4 rounded-2xl hover:bg-white hover:text-blue-600 transition-all duration-300 font-bold text-lg backdrop-blur-sm"
                >
                  View Profile
                </button>
              </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/20">
              ...
              <div className="p-8 text-center">
                <div className="max-w-md mx-auto">
                  <div className="w-24 h-24 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-white mb-6 mx-auto">
                    <Gamepad2 className="w-12 h-12" />
                  </div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Ready to Play?</h3>
                  <p className="text-gray-600 mb-8">Access our full collection of AI assessment games including Code Challenge, Personality Test, Code Battle, and more!</p>
                  <button 
                    onClick={() => router.push('/games')}
                    className="bg-gradient-to-r from-purple-600 to-pink-600 text-white py-4 px-8 rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all duration-300 font-bold text-lg flex items-center gap-3 mx-auto"
                  >
