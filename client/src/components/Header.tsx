            ...
            {!isAuthenticated ? (
              ...
              <div className="pt-4 border-t border-neutral-200 space-y-2">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center space-x-2 px-4 py-3 text-red-600 hover:text-red-700 hover:bg-red-50 rounded-xl transition-all duration-200"
                >
                  <LogOut className="w-4 h-4" />
                  <span className="font-medium">Sign Out</span>
                </button>
